#ifndef _HOME_PHONE_SEARCH_H
#define _HOME_PHONE_SEARCH_H

// 函数 搜索联系人
void home_phone_search() {
	...
	// 输入待搜索联系人公司
	char home_phone_search[20];
	printf(ENTER, "HOME_PHONE");
	scanf_s("%s", &home_phone_search, 20);
	...
	for (int i = 0; i < count; i++) {
		...
		// 发现待搜索联系人
		if (strcmp(home_phone_search, contact[i].home_phone) == 0) {
