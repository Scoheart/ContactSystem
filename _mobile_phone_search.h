#ifndef _MOBILE_PHONE_SEARCH_H
#define _MOBILE_PHONE_SEARCH_H

// 函数 搜索联系人
void mobile_phone_search() {
	...
	// 输入待搜索联系人公司
	char mobile_phone_search[20];
	printf(ENTER, "MOBILE_PHONE");
	scanf_s("%s", &mobile_phone_search, 20);
	...
	for (int i = 0; i < count; i++) {
		...
		// 发现待搜索联系人
		if (strcmp(mobile_phone_search, contact[i].mobile_phone) == 0) {
